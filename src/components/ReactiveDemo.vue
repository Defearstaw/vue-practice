<template>
  <div class="demo-container">
    ...
    <div class="input-group">
      ...
      <input v-model="userName" placeholder="Например: Иван" class="text-input" />
    ...
    <div class="input-group">
      ...
      <textarea v-model="userBio" placeholder="Расскажите о себе..." class="text-area" rows="3"></textarea>
