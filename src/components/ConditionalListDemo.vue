    ...
    <div v-else class="tech-list">
      ...
      >
        ...
        <div class="tech-actions">
          ...
          <button v-show="!tech.completed" @click="completeTechnology(tech.id)" class="complete-button">
            Завершить
          </button>
...
const completedCount = computed(() => technologies.value.filter(tech => tech.completed).length)
